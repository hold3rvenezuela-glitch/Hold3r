import { i as subscribe, n as ref, t as proxy } from "./vanilla-DQJJIeVl.js";
import { A as W3mFrameRpcConstants, I as NetworkController, M as SnackController, P as OptionsController, Z as subscribeKey, a as customElement, g as AccountController, h as ModalController, v as RouterController, y as ConnectionController, z as EventsController } from "./esm-BH0eap4U.js";
import { L as Yi, m as Gi } from "./index.es-BXGGKH0I.js";
//#region node_modules/@web3modal/siwe/dist/esm/core/controller/SIWEController.js
var state$1 = proxy({ status: "uninitialized" });
var SIWEController = {
	state: state$1,
	...
	_getClient() {
		if (!state$1._client) throw new Error("SIWEController client not set");
		return state$1._client;
	},
	async getNonce(address) {
		const nonce = await this._getClient().getNonce(address);
		this.setNonce(nonce);
		return nonce;
	},
	async getSession() {
		try {
			const session = await this._getClient().getSession();
			if (session) {
	...
	createMessage(args) {
		const message = this._getClient().createMessage(args);
		this.setMessage(message);
		return message;
	},
	async verifyMessage(args) {
		return await this._getClient().verifyMessage(args);
	},
	async signIn() {
	...
	onSignIn(args) {
		this._getClient().onSignIn?.(args);
	},
	onSignOut() {
		this._getClient().onSignOut?.();
	},
	setSIWEClient(client) {
		state$1._client = ref(client);
	...
	setSession(session) {
		...
		state$1.status = session ? "success" : "ready";
	}
};
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/@lit/reactive-element/development/css-tag.js
/**
* @license
...
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/@lit/reactive-element/development/reactive-element.js
/**
* @license
...
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/lit-html/development/lit-html.js
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/lit-element/development/lit-element.js
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
//#endregion
//#region node_modules/@web3modal/siwe/dist/esm/scaffold/partials/w3m-connecting-siwe/styles.js
...
`;
//#endregion
//#region node_modules/@web3modal/siwe/dist/esm/scaffold/partials/w3m-connecting-siwe/index.js
...
var W3mConnectingSiwe = class W3mConnectingSiwe extends LitElement {
	constructor() {
		super(...arguments);
...
W3mConnectingSiwe = __decorate$1([customElement("w3m-connecting-siwe")], W3mConnectingSiwe);
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/@lit/reactive-element/development/decorators/property.js
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
//#endregion
//#region node_modules/@web3modal/siwe/node_modules/@lit/reactive-element/development/decorators/state.js
/**
* @license
* Copyright 2017 Google LLC
* SPDX-License-Identifier: BSD-3-Clause
...
globalThis.litIssuedWarnings ??= /* @__PURE__ */ new Set();
//#endregion
//#region node_modules/@web3modal/siwe/dist/esm/scaffold/views/w3m-connecting-siwe-view/index.js
...
var W3mConnectingSiweView = class W3mConnectingSiweView extends LitElement {
	constructor() {
		super(...arguments);
	...
	onRender() {
		if (SIWEController.state.session) ModalController.close();
	}
	async onSign() {
		this.isSigning = true;
		...
		try {
			...
			const isSmartAccount = AccountController.state.preferredAccountType === W3mFrameRpcConstants.ACCOUNT_TYPES.SMART_ACCOUNT;
			if (isSmartAccount) SnackController.showError("This application might not support Smart Accounts");
...
__decorate([state()], W3mConnectingSiweView.prototype, "isSigning", void 0);
__decorate([state()], W3mConnectingSiweView.prototype, "isCancelling", void 0);
W3mConnectingSiweView = __decorate([customElement("w3m-connecting-siwe-view")], W3mConnectingSiweView);
//#endregion
export { SIWEController, Yi as getDidAddress, Gi as getDidChainId };
