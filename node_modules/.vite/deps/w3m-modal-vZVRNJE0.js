import { F as ApiController, M as SnackController, P as OptionsController, V as ThemeController, W as CoreHelperUtil, a as customElement, g as AccountController, h as ModalController, i as UiHelperUtil, o as initializeTheming, v as RouterController, z as EventsController } from "./esm-BH0eap4U.js";
import { a as html, r as LitElement, s as css, t as state } from "./decorators-Cg-cfQiL.js";
//#region node_modules/@web3modal/scaffold-ui/dist/esm/src/modal/w3m-modal/styles.js
...
`;
//#endregion
//#region node_modules/@web3modal/scaffold-ui/dist/esm/src/modal/w3m-modal/index.js
...
var W3mModal = class W3mModal extends LitElement {
	...
	async handleClose() {
		...
		if (this.isSiweEnabled) {
			const { SIWEController } = await import("./exports-CIg32rGV.js");
			if (SIWEController.state.status !== "success" && (isSiweSignScreen || isApproveSignScreen)) ModalController.shake();
	...
	onSiweNavigation() {
		if (this.open) RouterController.push("ConnectingSiwe");
		else ModalController.open({ view: "ConnectingSiwe" });
	}
};
...
__decorate([state()], W3mModal.prototype, "connected", void 0);
__decorate([state()], W3mModal.prototype, "loading", void 0);
