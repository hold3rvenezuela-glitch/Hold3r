 ...
 */
export declare function waitForTempoBlock<config extends Config>(config: config, parameters: waitForTempoBlock.Parameters<config>): Promise<waitForTempoBlock.ReturnValue>;
export declare namespace waitForTempoBlock {
    type Parameters<config extends Config> = ChainIdParameter<config> & Actions.zone.waitForTempoBlock.Parameters;
    type ReturnValue = Actions.zone.waitForTempoBlock.ReturnType;
    type ErrorType = Actions.zone.waitForTempoBlock.ErrorType;
    function queryKey<config extends Config>(parameters: PartialBy<Parameters<config>, 'tempoBlockNumber'>): readonly ["waitForTempoBlock", PartialBy<Parameters<config>, "tempoBlockNumber">];
    type QueryKey<config extends Config> = ReturnType<typeof queryKey<config>>;
    function queryOptions<config extends Config, selectData = ReturnValue>(config: Config, parameters: queryOptions.Parameters<config, selectData>): queryOptions.ReturnValue<config, selectData>;
    namespace queryOptions {
        type Parameters<config extends Config, selectData = waitForTempoBlock.ReturnValue> = PartialBy<waitForTempoBlock.Parameters<config>, 'tempoBlockNumber'> & QueryParameter<waitForTempoBlock.ReturnValue, waitForTempoBlock.ErrorType, selectData, waitForTempoBlock.QueryKey<config>>;
        type ReturnValue<config extends Config, selectData = waitForTempoBlock.ReturnValue> = QueryOptions<waitForTempoBlock.ReturnValue, waitForTempoBlock.ErrorType, selectData, waitForTempoBlock.QueryKey<config>>;
    }
}
/**
