const __vite__mapDeps=(i,m=__vite__mapDeps,d=(m.f||(m.f=["assets/exports-DmD4sIrU.js","assets/vanilla-BeoZKqUW.js","assets/esm-COLQ32c1.js","assets/rolldown-runtime-BcKkbAw3.js","assets/browser-BLmJMKa5.js","assets/index-CdsAQCvn.js","assets/index-C1DeGNpd.css"])))=>i.map(i=>d[i]);
import{F as e,M as t,P as n,V as r,W as i,a,g as o,h as s,i as c,o as l,v as u,z as d}from"./esm-COLQ32c1.js";import{a as f,c as p,l as m,o as h,s as g}from"./index-CdsAQCvn.js";var _=p`
  :host {
...
`,v=function(e,t,n,r){var i=arguments.length,a=i<3?t:r===null?r=Object.getOwnPropertyDescriptor(t,n):r,o;if(typeof Reflect==`object`&&typeof Reflect.decorate==`function`)a=Reflect.decorate(e,t,n,r);else for(var s=e.length-1;s>=0;s--)(o=e[s])&&(a=(i<3?o(a):i>3?o(t,n,a):o(t,n))||a);return i>3&&a&&Object.defineProperty(t,n,a),a},y=`scroll-lock`,b=class extends h{constructor(){super(),this.unsubscribe=[],this.abortController=void 0,this.open=s.state.open,this.caipAddress=o.state.caipAddress,this.isSiweEnabled=n.state.isSiweEnabled,this.connected=o.state.isConnected,this.loading=s.state.loading,this.shake=s.state.shake,this.initializeTheming(),e.prefetch(),this.unsubscribe.push(s.subscribeKey(`open`,e=>e?this.onOpen():this.onClose()),s.subscribeKey(`shake`,e=>this.shake=e),s.subscribeKey(`loading`,e=>{this.loading=e,this.onNewAddress(o.state.caipAddress)}),o.subscribeKey(`isConnected`,e=>this.connected=e),o.subscribeKey(`caipAddress`,e=>this.onNewAddress(e)),n.subscribeKey(`isSiweEnabled`,e=>this.isSiweEnabled=e)),d.sendEvent({type:`track`,event:`MODAL_LOADED`})}disconnectedCallback(){this.unsubscribe.forEach(e=>e()),this.onRemoveKeyboardListener()}render(){return this.open?g`
        ...
        `:null}async onOverlayClick(e){e.target===e.currentTarget&&await this.handleClose()}async handleClose(){let e=u.state.view===`ConnectingSiwe`,t=u.state.view===`ApproveTransaction`;if(this.isSiweEnabled){let{SIWEController:n}=await m(async()=>{let{SIWEController:e}=await import(`./exports-DmD4sIrU.js`);return{SIWEController:e}},__vite__mapDeps([0,1,2,3,4,5,6]));n.state.status!==`success`&&(e||t)?s.shake():s.close()}else s.close()}initializeTheming(){let{themeVariables:e,themeMode:t}=r.state,n=c.getColorTheme(t);l(e,n)}onClose(){this.open=!1,this.classList.remove(`open`),this.onScrollUnlock(),t.hide(),this.onRemoveKeyboardListener()}onOpen(){this.open=!0,this.classList.add(`open`),this.onScrollLock(),this.onAddKeyboardListener()}onScrollLock(){let e=document.createElement(`style`);e.dataset.w3m=y,e.textContent=`
      body {
        touch-action: none;
        overflow: hidden;
